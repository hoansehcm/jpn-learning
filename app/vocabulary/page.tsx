      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <section className="surface-panel rounded-[40px] p-6 sm:p-8 lg:p-10">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <div>
              <p className="text-sm uppercase tracking-[0.22em] text-soft">Từ vựng mỗi ngày</p>
              <h1 className="mt-3 font-serif text-4xl sm:text-5xl">Danh sách từ vựng dễ nhìn, dễ tra, dễ học lại</h1>
              <p className="mt-4 max-w-2xl text-soft leading-7">
                Mỗi mục từ hiển thị rõ chữ Nhật, kana, romaji và một ví dụ ngắn để bạn đọc lướt vẫn nắm được.
              </p>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-[22px] border border-[var(--border-color)] bg-[#fffaf4] pl-12 pr-4 py-3.5 outline-none focus:border-[var(--accent)]"
              />
            </div>
        ...
        <section className="grid gap-4">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
                <div className="flex-1">
                  <div className="flex items-center gap-3 flex-wrap">
                    <span className="rounded-full bg-[#fff1e8] px-3 py-1 text-xs font-semibold text-[var(--accent-strong)]">{item.level}</span>
                  ...
                  <div className="mt-4 rounded-[24px] bg-black/5 p-4">
                    <p className="text-soft">{item.examples[0].ja}</p>
                ...
                <div className="flex items-center gap-2 self-end lg:self-center">
                  ...
                  <Link href={`/vocabulary/${item.id}`} className="inline-flex items-center gap-2 rounded-full bg-black px-4 py-3 text-white">
                    Mở thẻ học
          ...
          {vocabList.length === 0 && (
            <div className="surface-card rounded-[32px] p-10 text-center">
              ...
              <p className="mt-4 text-lg font-semibold">Chưa có kết quả phù hợp</p>
              <p className="mt-2 text-soft">Thử tìm bằng kana, romaji hoặc bỏ bớt bộ lọc level.</p>
            </div>
          )}
        </section>
      </div>
